                ...
                @foreach ($products as $product)
                    <div class="content-appearance col-lg-3 p-0 product-card" id="content-price"
                        ...
                        <div class="product-image-container">
                            @if ($product->is_new)
                            <span class="badge badge-secondary">{{ __('translation.productsnew_new')}}</span>
                            @endif
                        ...
                        <div class="hover-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="product-price">{{ $product->price }} {{ __('translation.productsnew_tmt')}}</p>
                            </div>
                            <button class="add-to-cart" data-id="{{ $product->id }}"
                                data-title="{{ $product->title_ru }}" data-price="{{ $product->price }}"
                                data-image="{{ asset($product->image ?? '/images/product1.jpg') }}">{{ __('translation.productsnew_trash')}}</button>
                        </div>
                    </div>
                @endforeach
            </div>
