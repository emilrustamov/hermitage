...
<div class="admin-index">
    <div class="container mt-5">
        ...
        <form action="{{ route('admin.directions.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group mt-3">
                ...
                <div class="input-group">
                    <input id="main_image" class="form-control" type="text" name="main_image" value="{{ $category->main_image }}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="number" class="form-control" id="ordering" name="ordering" value="{{ $category->ordering }}" required>
            </div>
